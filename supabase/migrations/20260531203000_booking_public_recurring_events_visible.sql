-- Include recurring hosted events whose anchor `starts_at` is far in the past (weekly/daily series),
-- otherwise they disappear from the public `/book/[slug]` page and guests cannot choose dates.
