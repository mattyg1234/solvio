...
- [ ] Independent spec and code review passed; product-island regression fixed. Apply reviewed migration, commit only task files, push and verify production deployment.
- [ ] Report delivered scope and dependencies, including cancellation cutoff ambiguity and required reporting/templates inputs.
