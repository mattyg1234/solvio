...
import { CalendarDays, ClipboardList, CreditCard, LayoutDashboard, Megaphone, Mic2, Settings2 } from "lucide-react";
...
function buildMobileNav(cap: ResolvedPlatformCapabilities, campaignsEnabled: boolean): { href: string; label: string; icon: LucideIcon; exact?: boolean; key: string; badge?: string }[] {
  ...
  items.push({ href: "/dashboard/setup/bookings", label: "Setup", icon: ClipboardList, key: "booking-setup" });
