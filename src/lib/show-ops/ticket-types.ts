...
export function parseTicketTypeFields(fd: FormData) {
  ...
  return {
    ...
    adult_price_no_transport: amount("adult_price_no_transport", true),
    child_price_no_transport: amount("child_price_no_transport", true),
    infant_price_no_transport: amount("infant_price_no_transport", true),
    adult_nett: amount("adult_nett", true),
    child_nett: amount("child_nett", true),
